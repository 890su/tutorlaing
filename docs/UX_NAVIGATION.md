...
пространством занятия, пять стабильных переходов доступны снизу, а действия
...
- Нижняя клавиатура содержит только `Главное меню`, `Учиться`, `Инструменты`,
  `Прогресс`, `Настройки`. Она не содержит ответов на упражнения.
