...
2. постоянная reply-клавиатура — всегда видна, но занимает место и конфликтует
   со свободным текстовым ответом;
3. компактный dashboard — один рекомендуемый шаг и стабильные разделы.

Выбран компактный dashboard: Telegram остаётся рабочим пространством занятия,
а не каталогом функций.
